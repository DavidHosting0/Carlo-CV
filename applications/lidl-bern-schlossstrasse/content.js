 ...
 * Lidl Schweiz AG - Verkäufer / Verkäuferin (m/w/d) 20-60%, Bern, Schlossstrasse 115b
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/51402f0b-82b5-4f80-9b90-59b08df91a98/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Lidl Schweiz AG, Schlossstrasse 115b, 3008 Bern",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Verkäufer 20-60%",
    nationalitaet: "deutsch",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "Ich bin Carlo Koch, 19 Jahre alt und wohne nahe Oberbottigen in Bern. In Minijobs habe ich gelernt, auch bei hohem Andrang freundlich und zuverlässig zu arbeiten. Als Verkäufer bei Lidl an der Schlossstrasse möchte ich an der Kasse und auf der Fläche mit anpacken.",
    ausbildung: {
    ...
    skills: [
      ...
      "Flexibilität für Schichten inkl. Montag und Freitag",
      "Körperliche Belastbarkeit und Sorgfalt auf der Fläche",
    ...
    motivation: {
      ...
      absatz1: "hiermit bewerbe ich mich als Verkäufer 20-60% in der Filiale an der Schlossstrasse in Bern. Ich wohne in der Nähe von Oberbottigen und Bümpliz und bin flexibel für Einsätze von Montag bis Samstag. Eine abgeschlossene Detailhandelslehre bringe ich noch nicht mit. Ich möchte bei Lidl einsteigen und die Abläufe im Laden lernen.",
      absatz2: "Kassiertätigkeit, Warenverräumung und ein sauberes Erscheinungsbild der Fläche sind Aufgaben, die ich ernst nehme. Aus der Gastronomie kenne ich Schichtarbeit und Tempo. Digitale Systeme lerne ich schnell.",
      absatz3: "Deutsch ist meine Muttersprache. Ich bin körperlich fit und ab sofort oder nach Vereinbarung verfügbar. Über eine Rückmeldung freue ich mich.",
  ...
  en: {
    ...
    zielposition: "Sales Assistant 20-60%",
    nationalitaet: "German",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "I am Carlo Koch, 19, living near Oberbottigen in Bern. In mini jobs I learned to stay friendly and reliable when it is busy. As a sales assistant at Lidl on Schlossstrasse I want to support checkout and the shop floor.",
    ausbildung: {
    ...
    skills: [
      "Enjoy customer contact and checkout work",
      "Reliability and teamwork",
      "Flexibility for shifts including Monday and Friday",
      "Physical fitness and care on the shop floor",
      "Good German (native)",
    ...
    motivation: {
      ...
      absatz1: "I am applying for the Sales Assistant 20-60% role at Schlossstrasse in Bern. I live near Oberbottigen and Bümpliz and can work Monday to Saturday. I do not yet have a retail apprenticeship. I want to join Lidl and learn store operations.",
      absatz2: "Checkout, stocking and keeping the sales floor tidy are tasks I take seriously. From hospitality I know shift work and pace. I learn digital systems quickly.",
      absatz3: "German is my native language. I am physically fit and available immediately or by arrangement. I look forward to hearing from you.",
