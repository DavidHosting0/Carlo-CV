 ...
 * Virtual Experience GmbH Bern - Initiativbewerbung (Game Master / VR Host)
 */
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Virtual Experience GmbH - Maulbeerstrasse 8, 3011 Bern",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Mitarbeit im Team (Game Master / VR Host)",
    ...
    skills: [
      "Game Master und Host: Briefing, Betreuung, Session Flow",
      "Gruppen und Stosszeiten unter Druck",
      "VR Setup, Hygiene und kleine Probleme lösen",
    ...
    projekte: [
      {
        ...
        beschreibung:
          "Ich beschäftige mich schon länger mit VR und weiß, worauf es praktisch ankommt: Headset richtig einstellen, Spielbereich setzen, Controllers erklären und Erstspielern kurz helfen, bis sie sich zurechtfinden. Auch typische Probleme kenne ich, wenn Tracking hakelt, das WLAN schwach ist oder jemand unwohl wird, und wie man ruhig damit umgeht. Und natürlich hatte ich auch schon viel Spass mit VR Brillen.",
      },
      {
    ...
    motivation: {
      anrede: "Sehr geehrtes Team von Virtual Experience",
      absatz1:
        "hiermit bewerbe ich mich initiativ um eine Mitarbeit in eurem Team, gerne als Game Master oder VR Host oder in einer vergleichbaren Rolle rund um Empfang, Briefing, Betreuung und Session Abläufe. Ich bin 19 und weiß, dass ich noch jung bin, aber genau deshalb bin ich desto lernbereiter und motivierter, mich schnell einzuarbeiten und Verantwortung zu übernehmen. Ich wohne in Bern an der Bottigenstrasse 300. Obwohl aktuell keine Stelle ausgeschrieben ist, möchte ich mich vorstellen, falls ihr Verstärkung braucht oder bald sucht.",
      absatz2:
        "Virtual Experience verbindet genau das, was mir Spass macht: Menschen begrüssen und VR Escape Rooms erlebbar machen. Nach der Schule habe ich mehrere Monate bei EVA Köln West gearbeitet und Gäste durch Sessions begleitet, mit Headset, Controllers, kurzer Erklärung und Hilfe, wenn etwas hakt. Davor habe ich in der Gastronomie bei Burgerwerk und Am Fels Stosszeiten und Teamfit gelernt, und bei Burgerwerk ein digitales System eingeführt und geschult. In eurem Team will ich anpacken, eure Abenteuer und Abläufe lernen und dafür sorgen, dass Gruppen eine richtig gute Zeit haben.",
      absatz3:
        "Deutsch ist meine Muttersprache und Englisch spreche ich auf B2 Niveau, was für internationale Gäste hilfreich ist. Ich bin flexibel bei Abenden und Wochenenden und könnte ausserdem schon heute anfangen. Über ein Gespräch würde ich mich sehr freuen, gerne auch verbunden mit einem Probearbeitstag vor Ort an der Maulbeerstrasse.",
  ...
  en: {
    ...
    zielposition: "Team role (Game Master / VR Host)",
    ...
    skills: [
      "Game master and host: briefing, guest care, session flow",
      "Groups and peak times under pressure",
      "VR setup, hygiene and fixing small issues",
    ...
    motivation: {
      anrede: "Dear Virtual Experience team",
      absatz1:
        "I am writing with an unsolicited application to join your team, ideally as game master or VR host or a similar role around reception, briefing, guest care and session flow. I am 19 and I know I am still young, but that is exactly why I am all the more eager to learn and motivated to get up to speed quickly and take on responsibility. I live in Bern at Bottigenstrasse 300. Even though you have no open roles listed right now, I would like to introduce myself in case you need support or will hire soon.",
      absatz2:
        "Virtual Experience combines what I enjoy: welcoming people and making VR escape rooms feel easy. After school I worked for several months at EVA Köln West and guided guests through sessions with headset, controllers, a short intro and help when something glitches. Before that I learned peak times and team fit in hospitality at Burgerwerk and Am Fels, and at Burgerwerk I rolled out and trained a digital system. In your team I want to jump in, learn your adventures and flow and make sure groups have a really good time.",
      absatz3:
        "German is my native language and English is B2, which helps with international guests. I am flexible on evenings and weekends and could also start as early as today. I would be very happy to have a conversation, ideally together with a trial day on site at Maulbeerstrasse.",
