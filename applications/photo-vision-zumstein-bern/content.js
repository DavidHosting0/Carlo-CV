 ...
 * Photo Vision Zumstein AG - Verkäufer/in Foto & Video 80-100%, Bern Casinoplatz
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/0f39ba31-c0aa-4497-888f-172c97e3a90f/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Photo Vision Zumstein AG, Casinoplatz 8, 3011 Bern",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Verkäufer Foto und Video 80-100%",
    nationalitaet: "deutsch",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "Ich bin Carlo Koch, 19 Jahre alt und wohne nahe Oberbottigen in Bern. Digitale Technik interessiert mich und bei Burgerwerk habe ich ein digitales System eingeführt. Als Verkäufer bei Photo Vision Zumstein möchte ich Kundinnen und Kunden bei Foto und Video Produkten unterstützen und Abläufe im Laden mittragen.",
    ausbildung: {
    ...
    skills: [
      "Interesse an Foto, Video und digitaler Technik",
      "Freude an Beratung und Kundenkontakt",
      "Schnelle Auffassungsgabe bei Produkten und Systemen",
      "Zuverlässigkeit und gepflegtes Auftreten",
      "Fliessende Deutschkenntnisse und Englisch B2"
],
    projekte: [
      {
    ...
    motivation: {
      anrede: "Sehr geehrtes Photo Vision Zumstein Team",
      absatz1: "hiermit bewerbe ich mich als Verkäufer 80-100% in Bern am Casinoplatz. Ich wohne nahe Oberbottigen und erreiche die Innenstadt gut. Verkaufserfahrung im Fotofachhandel bringe ich noch nicht mit. Ich möchte bei Photo Vision Zumstein einsteigen, Produkte kennenlernen und Kundinnen und Kunden ehrlich beraten.",
      absatz2: "Bestellungen, Reparaturannahme und den Mietservice Zumirent kann ich mir gut vorstellen, weil ich gerne erkläre und digital denke. Bei Burgerwerk habe ich ein digitales Tool programmiert, eingeführt und das Team geschult. Fachwissen zu Kameras und Zubehör würde ich im Alltag gezielt aufbauen.",
  ...
  en: {
    ...
    zielposition: "Sales Assistant Photo and Video 80-100%",
    nationalitaet: "German",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "I am Carlo Koch, 19, living near Oberbottigen in Bern. I am interested in digital technology and at Burgerwerk I introduced a digital system. As a sales assistant at Photo Vision Zumstein I want to support customers with photo and video products and help run the store.",
    ausbildung: {
    ...
    skills: [
      "Interest in photo, video and digital technology",
      "Enjoy advising customers",
      "Quick learner with products and systems",
      "Reliability and a neat appearance",
      "Fluent German and English B2"
],
    projekte: [
      {
    ...
    motivation: {
      anrede: "Dear Photo Vision Zumstein team",
      absatz1: "I am applying for the sales assistant role 80-100% in Bern at Casinoplatz. I live near Oberbottigen and can reach the city centre well. I do not yet have sales experience in photo retail. I want to join Photo Vision Zumstein, learn the products and advise customers honestly.",
      absatz2: "Orders, repair intake and the Zumirent rental service suit me because I like explaining things and think digitally. At Burgerwerk I programmed a digital tool, introduced it and trained the team. I would build camera and accessory knowledge step by step on the job.",
