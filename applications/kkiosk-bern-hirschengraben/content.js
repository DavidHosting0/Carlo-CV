 ...
 * k kiosk (Valora) - Verkäuferin / Verkäufer k kiosk 32 Std., Bern, Hirschengraben 24
 * Stelle: https://career.valora.com/de/job/6334/verkauferin-verkaufer-k-kiosk-32-std
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "k kiosk, Hirschengraben 24, 3011 Bern",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Verkäufer k kiosk (32 Std./Woche)",
    nationalitaet: "deutsch",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "Ich bin Carlo Koch, 19 Jahre alt und wohne in Bern. Für den k kiosk am Hirschengraben bewerbe ich mich um 32 Stunden pro Woche. Kundenkontakt und Schichtarbeit kenne ich aus der Gastronomie.",
    ausbildung: {
    ...
    skills: [
      "Freundliche Beratung Food und Non Food",
      "Kasse und Bestellungen",
      "Sorgfalt bei Warenpräsentation",
      "Flexibilität für Schichten inkl. Abend",
      "Teamfähigkeit",
    ...
    motivation: {
      ...
      absatz1: "hiermit bewerbe ich mich als Verkäufer für 32 Stunden pro Woche im k kiosk am Hirschengraben in Bern. Der Standort ist gut erreichbar. Ich bringe Motivation und Kundenkontakt Erfahrung mit.",
      absatz2: "Beratung, Kasse, Warenbewirtschaftung und ein ordentlicher Arbeitsplatz möchte ich zuverlässig übernehmen. Abendzuschläge und flexible Schichten passen zu mir.",
  ...
  en: {
    ...
    zielposition: "k kiosk Sales Assistant (32 hrs/week)",
    nationalitaet: "German",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "I am Carlo Koch, 19, living in Bern. I am applying for 32 hours per week at the k kiosk on Hirschengraben. I know customer contact and shift work from hospitality.",
    ausbildung: {
    ...
    skills: [
      "Friendly Food and Non-Food advice",
      "Checkout and orders",
      "Care with product presentation",
      "Flexibility for shifts including evenings",
      "Teamwork",
      "German native"
],
    projekte: [
    ...
    motivation: {
      ...
      absatz1: "I am applying for the 32 hours/week sales role at the k kiosk on Hirschengraben in Bern. The location is easy to reach. I bring motivation and customer contact experience.",
      absatz2: "Advice, checkout, stock work and a tidy workplace are tasks I want to take on reliably. Evening bonuses and flexible shifts suit me.",
