 ...
 * OTTO'S AG - Aushilfe Verkäufer:in Food/Non-Food 60-80%, Frauenkappelen
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/4a171af4-32db-450a-b15c-5792b7c0ac70/
 * Distanz zu Oberbottigen: ca. 6.0 km
 */
const CV_SHARED = {
  ...
  arbeitgeberZiel: "OTTO'S AG, Filiale Frauenkappelen, 3202 Frauenkappelen",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Aushilfe Verkäufer Food/Non-Food 60-80%",
    nationalitaet: "deutsch",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "Ich bin Carlo Koch, 19 Jahre alt und wohne nahe Oberbottigen in Bern. Frauenkappelen liegt für mich im nahen Umfeld. In Minijobs habe ich gelernt, kundenorientiert und belastbar zu arbeiten. Als Aushilfe Food und Non-Food bei OTTO'S möchte ich an der Kasse und bei der Warenpräsentation mithelfen.",
    ausbildung: {
    ...
    skills: [
      "Freude am Verkauf und am Kundenkontakt",
    ...
    motivation: {
      ...
      absatz1: "hiermit bewerbe ich mich als Aushilfe Verkäufer Food und Non-Food 60-80% in Frauenkappelen. Ich wohne nahe Oberbottigen und Bümpliz und erreiche die Filiale gut. Erste Erfahrung im Dienstleistungsbereich bringe ich aus der Gastronomie mit. Eine Detailhandelslehre habe ich noch nicht abgeschlossen.",
      absatz2: "Warenpräsentation, Scanning Kasse, Lager und Sauberkeit auf der Fläche sind Aufgaben, die ich ernst nehme. Ich arbeite kundenorientiert, bin belastbar und lerne digitale Kassensysteme schnell.",
  ...
  en: {
    ...
    zielposition: "Sales Assistant Food/Non-Food 60-80%",
    nationalitaet: "German",
    meta: { kennzeichnung: "", hinweis: "" },
    kurzprofil: "I am Carlo Koch, 19, living near Oberbottigen in Bern. Frauenkappelen is in my local area. In mini jobs I learned to work in a customer focused and resilient way. As a Food and Non-Food assistant at OTTO'S I want to support checkout and product presentation.",
    ausbildung: {
    ...
    skills: [
      "Enjoy sales and customer contact",
    ...
    motivation: {
      ...
      absatz1: "I am applying for the Food and Non-Food sales assistant role 60-80% in Frauenkappelen. I live near Oberbottigen and Bümpliz and can reach the store well. I have first service experience from hospitality. I have not completed a retail apprenticeship yet.",
      absatz2: "Product presentation, scanning checkout, stock and cleanliness on the floor are tasks I take seriously. I work in a customer focused way, stay resilient and learn digital POS systems quickly.",
