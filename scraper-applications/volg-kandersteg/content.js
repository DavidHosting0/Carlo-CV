 ...
 * Volg Detailhandels AG - Verkäuferin, Verkäufer, Kandersteg
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/937a13a8-e16a-4484-8ae4-1ddaf3be7213/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Volg Detailhandels AG, Kandersteg",
};
...
const CV_I18N = {
  ...
  en: {
    ...
    kurzprofil:
      "I am Carlo Koch, 19 years old and living in Bern. In hospitality and guest-service mini jobs I learned to work reliably and courteously under time pressure and to contribute in a team. At Burgerwerk I also developed a digital system, introduced it and trained colleagues. As a sales assistant at Volg in Kandersteg I want to support checkout, goods receiving and shelf work.",
    ausbildung: {
    ...
    motivation: {
      ...
      absatz1:
        "I am applying for the Sales Assistant role at Volg in Kandersteg. I am 19, live in Bern and already have experience working with people under time pressure. I do not yet have a completed retail apprenticeship. I would like to join Volg, get stuck in and learn store operations thoroughly.",
      absatz2:
