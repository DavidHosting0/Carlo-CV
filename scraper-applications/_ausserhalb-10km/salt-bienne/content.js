 ...
 * Salt Mobile SA - Salt Store Verkäufer/in Bienne/Biel 80%-100%, Biel/Bienne
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/05e7794b-a12a-4bd8-9490-826e7ac5fada/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Salt Mobile SA, Salt Store Biel/Bienne",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Salt Store Verkäufer 80-100%",
    ...
    motivation: {
      ...
      absatz1:
        "hiermit bewerbe ich mich als Salt Store Verkäufer 80-100% bei Salt in Biel/Bienne. Ich bin 19, wohne in Bern und bringe Erfahrung aus kundenorientierten Minijobs mit. Eine abgeschlossene Lehre im Detailhandel habe ich noch nicht. Ich möchte im Salt Store einsteigen, Abläufe lernen und Kundinnen und Kunden ehrlich beraten.",
      absatz2:
  ...
  en: {
    ...
    motivation: {
      ...
      absatz1:
        "I am applying for the Salt Store Sales Advisor role at Salt in Biel/Bienne. I am 19, live in Bern and bring experience from customer-facing mini jobs. I do not yet have a completed retail apprenticeship. I want to join the Salt Store, learn the processes and advise customers honestly.",
      absatz2:
