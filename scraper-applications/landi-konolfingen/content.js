 ...
 * LANDI Aare Genossenschaft - Verkäufer TopShop w/m/d, Konolfingen
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/65ff7dce-45f8-4859-9026-264d9dc5276f/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "LANDI Aare Genossenschaft, Konolfingen",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Verkäufer TopShop",
    ...
    kurzprofil:
      "Ich bin Carlo Koch, 19 Jahre alt und wohne in Bern. Kundenkontakt, Ordnung im Sortiment und zuverlässige Teamarbeit kenne ich aus Minijobs in der Gastronomie und Gästebetreuung. Bei Burgerwerk habe ich ein digitales System eingeführt und Kollegen geschult. Als Verkäufer im TopShop der LANDI in Konolfingen möchte ich Kundinnen und Kunden beraten und im Laden mit anpacken.",
    ausbildung: {
    ...
    skills: [
      "Freude an Beratung und Verkauf im Laden",
      "Zuverlässigkeit und saubere Abläufe im Team",
      "Bereitschaft zu flexiblen Einsätzen je nach Pensum",
      "Sorgfalt bei Warenpräsentation und Bestand",
    ...
    motivation: {
      ...
      absatz1:
        "hiermit bewerbe ich mich als Verkäufer TopShop bei der LANDI in Konolfingen. Ich bin 19, wohne in Bern und bringe Erfahrung aus kundenorientierten Minijobs mit. Eine Detailhandelslehre habe ich noch nicht abgeschlossen. Ich möchte mich im TopShop einarbeiten und Produkte sowie Abläufe gründlich lernen.",
      absatz2:
        "Im TopShop reizt mich der direkte Verkauf und die Beratung zu einem breiten Sortiment. Ich arbeite gerne mit Menschen, halte Ordnung und denke im Team mit. Aus der Gastronomie kenne ich Stosszeiten und weiss, wie wichtig freundliche und klare Kommunikation ist.",
      absatz3:
        "Deutsch ist meine Muttersprache. Ich bin motiviert, lernbereit und ab sofort oder nach Vereinbarung verfügbar. Über ein Gespräch freue ich mich.",
  ...
  en: {
    ...
    zielposition: "TopShop Sales Assistant",
    ...
    kurzprofil:
      "I am Carlo Koch, 19, living in Bern. I know customer contact, tidy assortments and reliable teamwork from hospitality and guest-service jobs. At Burgerwerk I introduced a digital system and trained colleagues. As a TopShop sales assistant at LANDI in Konolfingen I want to advise customers and support store operations.",
    ausbildung: {
    ...
    skills: [
      "Enjoy advising and selling in-store",
      "Reliability and clean teamwork",
      "Flexible availability depending on workload",
      "Care with product presentation and stock",
    ...
    motivation: {
      ...
      absatz1:
        "I am applying for the TopShop Sales Assistant role at LANDI in Konolfingen. I am 19, live in Bern and bring experience from customer-facing mini jobs. I have not completed a retail apprenticeship yet. I want to learn the TopShop products and processes thoroughly.",
      absatz2:
        "I am drawn to direct sales and advising across a broad assortment. I enjoy working with people, keep things orderly and contribute in a team. From hospitality I know busy periods and the value of clear, friendly communication.",
      absatz3:
        "German is my native language. I am motivated, eager to learn and available immediately or by arrangement. I look forward to a conversation.",
