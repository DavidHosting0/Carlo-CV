 ...
 * Magic X Retail AG - Verkäufer/in 30-40% (m/w/d) für Lyssach im Stundenlohn, Lyssach
 * Stelle: https://www.jobs.ch/de/stellenangebote/detail/9c92ca33-fa16-45f0-8ff0-08942bfff6cb/
...
const CV_SHARED = {
  ...
  arbeitgeberZiel: "Magic X Retail AG, Lyssach",
};
...
const CV_I18N = {
  de: {
    ...
    zielposition: "Verkäufer 30-40% (Stundenlohn)",
    ...
    motivation: {
      ...
      absatz1:
        "hiermit bewerbe ich mich als Verkäufer 30-40% (Stundenlohn) bei Magic X in Lyssach. Ich bin 19 und wohne in Bern. Ich suche eine Teilzeitstelle mit Kundenkontakt, in der ich zuverlässig mithelfe und mich schnell einarbeite.",
      absatz2:
  ...
  en: {
    ...
    motivation: {
      ...
      absatz1:
        "I am applying for the Sales Assistant (part-time) role at Magic X in Lyssach. I am 19 and live in Bern. I am looking for a part-time role with customer contact where I can contribute reliably and learn quickly.",
      absatz2:
